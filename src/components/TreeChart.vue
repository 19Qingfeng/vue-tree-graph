<template>
    <table v-if="treeData.name">
            ...
            >
                <div :class="{node: true, hasMate: treeData.mate}">
                    ...
                    >
                        ...
                        <div class="name">{{treeData.body}}</div>
                    </div>
                    <div
                        class="add"
                        @click="$emit('click-node', treeData)"
        ...
        <tr
            v-if="Array.isArray(treeData.children) && treeData.children.length && treeData.extend"
        ...
        <div
            v-else
            class="over_line"
            :style="{ 'height':`${(level- treeData.level + 1) * height}px`,'border-bottom': treeData.id === id ? 'none' : '1px solid red'}"
        />wśsa
    </table>
</template>
